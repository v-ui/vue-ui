...
const validators = {
  ...
  UNmber: value => tool.obj.type.isNumber(value) || tool.obj.type.isString(value) && !isNaN(value) && Number(value) >= 0,
...
export default {
  ...
  // type
  String: { type: [Number, String], default: '', validator: value => type.validString(value) },
  Number: { type: [Number, String], default: 0, validator: value => type.validNumber(value) },
  UNmber: { type: [Number, String], default: 0, validator: value => type.validUNumber(value) },
