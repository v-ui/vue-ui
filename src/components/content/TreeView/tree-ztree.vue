...
export default {
  ...
  async created() {
    await require("ztree/js/jquery.ztree.all.min.js")
    await require("ztree/js/jquery.ztree.core.min.js")
    await require("ztree/js/jquery.ztree.excheck.min.js")
    await require("ztree/js/jquery.ztree.exhide.min.js")
  },
};
</script>
