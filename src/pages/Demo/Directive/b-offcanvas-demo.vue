<template>
  <div>
    ...
    <div class="row align-items-center py-1">
      ...
      <div class="col-1">
        <b-switch v-model="scroll" label="scroll" />
      </div>
    </div>
    <div class="row align-items-center py-1">
      <font class="col-1">
